# Save as: challenge_I2_performance_enhanced.py
"""
Challenge I.2: Enhanced Software Performance Checks
Modified from original benchmark script with additional features
"""
...
# =====================================================================
# 2. Custom Calculator Wrappers (with timing)
# =====================================================================
...
# =====================================================================
# 5. Main Benchmark Setup - Enhanced
# =====================================================================
if __name__ == "__main__":
    ...
    try:
        ...
        if shutil.which('pw.x'):
            methods['QE (DFT)'] = lambda: Espresso(
                profile=EspressoProfile(command='pw.x'),
                pseudopotentials={'H': 'H.upf', 'O': 'O.upf'},
                input_data={'system': {'ecutwfc': 30, 'ecutrho': 120}},
                kpts=(1, 1, 1)
            )
        ...
        print("⚠ Quantum ESPRESSO not available - skipping")
